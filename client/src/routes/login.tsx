...
function Login() {
  ...
  const inputVariants = tv({
    ...
    variants: {
      colors: {
        initial: "ring-gray-300 placeholder:text-gray-400 focus:ring-indigo-600",
        error: "border-red-600 text-red-600 ring-red-600 focus:ring-red-600 focus:ring-2 focus:ring-inset focus:ring-red-600"
      }
    },
    defaultVariants: {
      colors: "initial"
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      type="email"
                      autoComplete="email"
                      className={inputVariants({ colors: errors.email ? 'error' : 'initial' })}
